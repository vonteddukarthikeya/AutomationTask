...
//Page Factory Approach
	...
	@FindBy(xpath="//span[text()='First Name']") WebElement FirstNameText;
	@FindBy(xpath="//span[text()='Last Name']") WebElement LastNameText;
	@FindBy(xpath="//span[text()='User Name']") WebElement UserNameText;
	@FindBy(xpath="//span[text()='Customer']") WebElement CustomerText;
	@FindBy(xpath="//span[text()='Role']") WebElement RoleText;
	@FindBy(xpath="//span[text()='E-mail']") WebElement EmailText;
	@FindBy(xpath="//span[text()='Cell Phone']") WebElement CellPhoneText;
	@FindBy(xpath="//span[text()='Locked']") WebElement LockedText;
	@FindBy(name="FirstName") WebElement FirstNameField;
	@FindBy(css="input[name='LastName']") WebElement LastNameField;
	@FindBy(css="input[name='UserName']") WebElement UserNameField;
	@FindBy(xpath="//input[@class='ng-pristine ng-valid'][@name='Password']") WebElement PasswordField;
	@FindBy(xpath="//input[@class='ng-pristine ng-valid'][@type='radio'][@value='15']")	WebElement CustomerField;
    @FindBy(xpath="//option[text()='Customer']") WebElement RoleField;
    @FindBy(css="input[name='Email']") WebElement EmailField;
    @FindBy(xpath="//input[@name='Mobilephone']") WebElement PhoneField;
    @FindBy(xpath="//button[@class='btn btn-success']") WebElement SaveButtonField;
    @FindBy(xpath="//input[@class='pull-right ng-pristine ng-valid']") WebElement SearchField;
    @FindBy(xpath="//table/tbody/tr[1]/td[1]") WebElement TableData;
